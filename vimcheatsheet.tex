...
\verb!:Ctrl + d ! \hfill Delete buffer but keep the current \\ \hfill window.\\
...
\verb! !\\
\verb!Ctrl + h/j/k/l! \hfill Move to * window (works for \\ \hfill tmux too).\\
\verb!Ctrl + w + =!  \hfill Equalize height and width of all windows.\\
\verb! !\\

\section{fzf}
\verb!Ctrl-p! \hfill Search file in project root.\\
\verb!Ctrl-e! \hfill Search MRU files.\\
\verb!Ctrl-g! \hfill Search for keyword in project root(all files)\\
\verb!Ctrl-X! \hfill Open file in split.\\
\verb!Ctrl-V! \hfill Open file in vertical split.\\
\verb!Tab! \hfill Mark file to open multiple files.\\

\section{NERDTree}
\verb!Ctrl-n! \hfill NERDTreeToggle\\
\verb!l! \hfill Open current node\\
\verb!Space! \hfill Open current node recursively\\
